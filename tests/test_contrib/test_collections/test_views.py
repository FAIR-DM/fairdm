...
class TestQueryCount:
    ...
    One piece of measurement hygiene makes this readable at the page level, and it is
    load-bearing.

    The page is fetched once before either measurement. The first request in a test
    process does one-time work the second never repeats - the site cache, the identity
    records, their savepoints - which shows up as the first count being the larger one
    however flat the feature is.
    """
