...
The [FairDM Constitution](https://github.com/FAIR-DM/fairdm/blob/main/CONSTITUTION.md) defines the project's core principles, architecture constraints, development workflow, and governance model. It serves as the foundation for all design decisions and contributions to the framework.
