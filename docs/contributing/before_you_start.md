...
```{seealso}
**Constitution**: Before making changes, read the [FairDM Constitution](https://github.com/FAIR-DM/fairdm/blob/main/CONSTITUTION.md) to understand the framework's goals and constraints.
```
