...
4. **Fix Dataset/Project Integration Tests** → Fixes 13 tests
   - Depends on fixtures and factories working
5. **Review Admin Interface** → Fixes 6 admin tests

### Phase 3: Cleanup (Low Impact)
6. **Fix Measurement URL Test** → 1 test
7. **Fix Registry Validation Test** → 1 test (may be working correctly)
