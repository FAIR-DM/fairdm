...
## Recent Changes
- 011-restful-api: Added Python 3.11+ + Django 5.1.3+, djangorestframework, drf-spectacular[sidecar], dj-rest-auth, drf-orjson-renderer, django-cors-headers, djangorestframework-guardian
- 011-restful-api: Added Python 3.11+ + Django 5.1.3+, djangorestframework, drf-spectacular[sidecar], dj-rest-auth, django-rest-polymorphic, drf-orjson-renderer, drf-schema-adapter (compatibility risk — see R7), django-parler-rest, django-cors-headers, djangorestframework-guardian
