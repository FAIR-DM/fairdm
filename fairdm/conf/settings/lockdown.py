...
print(f"LOCKDOWN_ENABLED: {LOCKDOWN_ENABLED}")
# print(f"LOCKDOWN_FORM: {LOCKDOWN_FORM}")
print(f"LOCKDOWN_AUTHFORM_STAFF_ONLY: {LOCKDOWN_AUTHFORM_STAFF_ONLY}")
print(f"LOCKDOWN_AUTHFORM_SUPERUSERS_ONLY: {LOCKDOWN_AUTHFORM_SUPERUSERS_ONLY}")
print(f"LOCKDOWN_PASSWORDS: {LOCKDOWN_PASSWORDS}")
