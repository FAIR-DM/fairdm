...
from .views import CollectionsOverview, DataTableView, MeasurementsOverview, SamplesOverview
...
urlpatterns = [
    ...
    path("collections/measurements/", MeasurementsOverview.as_view(), name="measurements-overview"),
