...
| ForeignKey | Column (shows __str__) | Use accessor for nested: `project__title` |
...
From [FR-003](../../specs/004-fairdm-registry/spec.md#L86):
...
**Validation** (from [FR-016](../../specs/004-fairdm-registry/spec.md#L99)):
...
| ForeignKey | ✅ __str__ | ✅ Dropdown | ✅ Select2 | Support __ paths |
