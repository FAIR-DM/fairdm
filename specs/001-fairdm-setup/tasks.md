...
**Branch**: `001-fairdm-setup`
**Input**: Design documents from `/specs/001-fairdm-setup/`
...
- [X] T035 Create `docs/portal-administration/configuration-checks.md` based on `specs/001-fairdm-setup/quickstart.md`
