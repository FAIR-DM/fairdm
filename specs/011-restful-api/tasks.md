...
- [ ] T023 ⚠️ CRITICAL: Run Django system checks: `poetry run python manage.py check` — MUST pass before proceeding
- [ ] T024 ⚠️ CRITICAL: Run User Story 1 tests: `poetry run pytest tests/test_api/test_viewsets.py tests/test_api/test_router.py tests/test_api/test_pagination.py -v` — ALL tests MUST pass
